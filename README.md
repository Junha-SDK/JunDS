<div align="center">
  ...
  <p>
    <img src="https://img.shields.io/badge/components-320-blue" alt="Components" />
    <img src="https://img.shields.io/badge/hooks-62-green" alt="Hooks" />
...
JunDS는 **MCP 서버를 내장**합니다. 이 리포지토리를 Cursor / Claude Code / Windsurf 같은 AI 에디터로 열면 320개 컴포넌트의 prop 시그니처·접근성 보고서·레시피·요구사항을 AI가 직접 조회해 코드를 만듭니다 — hallucination 없이.
...
- **320 컴포넌트** — 13 Core, 12 Layout, 51 Primitives, 201 Composites, 43 Patterns (+ finance 86)
