...
const PAGES: { label: string; href: string; description: string; group: string }[] = [
  ...
  { label: "종목 비교", href: "/compare", description: "여러 종목 한 번에", group: "분석" },
  {
    label: "AI 투자자 위원회",
    href: "/investors",
    description: "버핏·린치·멍거 8명의 거장 분석",
    group: "분석",
  },
  {
    label: "위원회 합의 스크리너",
    href: "/investors/consensus",
    description: "다수 매수 종목을 한눈에",
    group: "분석",
  },
  {
    label: "백테스트",
    href: "/backtest",
    description: "거장 룰을 과거 데이터에 적용",
    group: "분석",
  },
  ...
  { label: "매매손익", href: "/portfolio", description: "일별 실현 손익", group: "내 정보" },
  {
    ...
    description: "현재 포지션과 평가손익",
    group: "내 정보",
  },
  {
    label: "포지션 × 위원회",
    href: "/portfolio/council",
    description: "내 종목별 거장 의견",
    group: "내 정보",
  },
