...
export interface YearPickerProps extends Omit<HTMLAttributes<HTMLDivElement>, "onChange" | "defaultValue"> {
  /** 현재 선택값 */
  value?: number;
  /** 기본값 */
  defaultValue?: number;
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-3">
        ...
        <div className="text-sm font-semibold">{years[0]} – {years[years.length - 1]}</div>
        <button
          type="button"
          onClick={() => setPage((p) => p + pageSize)}
          aria-label="다음 페이지"
