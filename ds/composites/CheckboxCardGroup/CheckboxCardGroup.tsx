...
export interface CheckboxCardGroupProps extends Omit<HTMLAttributes<HTMLDivElement>, "onChange" | "defaultValue"> {
  /** 옵션 */
 ...
 * @tags input
 */
export const CheckboxCardGroup = forwardRef<HTMLDivElement, CheckboxCardGroupProps>(function CheckboxCardGroup(
