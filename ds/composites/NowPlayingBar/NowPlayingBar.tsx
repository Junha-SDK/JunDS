...
const iconBtn =
  "grid h-9 w-9 place-items-center rounded-full text-foreground/80 transition-colors hover:bg-card-hover hover:text-foreground focus-visible:outline-2 focus-visible:outline-primary focus-visible:outline-offset-2";
            ...
            <div className="mx-auto flex max-w-6xl items-center gap-4 px-4 py-2.5">
              ...
              <div className="flex min-w-0 flex-1 items-center gap-3 sm:max-w-xs">
                {onExpand ? (
                  <button
                    ...
                    className="relative shrink-0 rounded-lg focus-visible:outline-2 focus-visible:outline-primary focus-visible:outline-offset-2"
                  >
                    {art}
                    <span
                      className="absolute inset-0 grid place-items-center rounded-lg bg-black/45 text-white opacity-0 transition-opacity hover:opacity-100"
                      aria-hidden="true"
                    >
              ...
              <div className="flex flex-[2] flex-col items-center gap-1">
                <div className="flex items-center gap-1">
                  <button type="button" onClick={player.prev} aria-label="이전 곡" className={iconBtn}>
                  ...
                  <button
                    ...
                    className={cn(iconBtn, "h-10 w-10 bg-primary text-white hover:bg-primary-hover hover:text-white")}
                  >
                    {isPlaying ? (
                  ...
                  <button type="button" onClick={player.next} aria-label="다음 곡" className={iconBtn}>
                    <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor" aria-hidden="true">
