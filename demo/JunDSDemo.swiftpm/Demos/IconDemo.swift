...
enum IconDemo {
    static let demo = ComponentDemo(
        ...
        controls: [
            ...
            .options(
                "symbol", "symbol", ["star", "heart", "bell", "gear", "bolt"], initial: "star"),
            .options(
                "color", "color", ["primary", "muted", "danger", "success"], initial: "primary"),
        ],
...
private let iconNote =
    "JdIconSize.side는 웹 SVG 박스의 변이고 SF Symbol의 pointSize는 글리프 기준이라 "
