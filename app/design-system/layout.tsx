...
import { FrameworkWrapper } from "./_components/FrameworkWrapper";
import Link from "next/link";

export default function DesignSystemLayout({ children }: { children: React.ReactNode }) {
  return (
    <FrameworkWrapper>
      <Flex h="100vh" overflow="hidden" bg="background" color="foreground" transition="colors">
        <ThemeRestorer />
