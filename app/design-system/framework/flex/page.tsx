        ...
        <Preview>
          <div className="space-y-4">
            <Flex gap="sm" align="center">
              {[1,2,3].map(n => <Box key={n} p={3} bg="primary" radius="md" color="white"><span className="text-xs">Item {n}</span></Box>)}
            </Flex>
            <Flex direction="column" gap="sm">
              {[1,2,3].map(n => <Box key={n} p={3} bg="info" radius="md" color="white"><span className="text-xs">Item {n}</span></Box>)}
            </Flex>
          </div>
        </Preview>
      </Section>
      <Section title="Justify & Align">
        <Preview>
          <Flex justify="between" align="center" p={4} bg="surface-raised" radius="lg" border>
            <Box p={2} bg="primary" radius="sm" color="white"><span className="text-xs">Left</span></Box>
            <Box p={2} bg="success" radius="sm" color="white"><span className="text-xs">Center</span></Box>
            <Box p={2} bg="danger" radius="sm" color="white"><span className="text-xs">Right</span></Box>
          </Flex>
        </Preview>
      </Section>
    </ComponentPage>
