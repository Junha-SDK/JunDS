      ...
      props={[
        {
          ...
          type: "string",
          default: '"purple"',
          description: "테마 이름 또는 primary 색상 hex",
        },
        {
          name: "colorMode",
        ...
        },
        {
          ...
          default: '"normal"',
          description: "전역 UI 밀도",
        },
        {
          name: "radius",
          type: '"none"|"sm"|"md"|"lg"|"full"',
          default: '"md"',
          description: "전역 border-radius 프리셋",
        },
        {
          name: "spacing",
          type: '"tight"|"default"|"relaxed"',
          default: '"default"',
          description: "전역 간격 배율",
        },
      ...
      <Section title="기본 사용법">
        <Preview>
          <div className="p-4 bg-gray-50 rounded-xl text-sm font-mono space-y-1">
            ...
            <p>{"<JunDSProvider"}</p>
            <p className="pl-4 text-primary-ink">{'theme="purple"'}</p>
            <p className="pl-4 text-primary-ink">{'colorMode="system"'}</p>
            <p className="pl-4 text-primary-ink">{'density="normal"'}</p>
            <p className="pl-4 text-primary-ink">{'radius="md"'}</p>
            <p>{">"}</p>
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div className="p-3 border border-border rounded-lg">
              ...
              <p className="text-muted text-xs">
                18개 프리셋 + 커스텀 색상. 모든 컴포넌트의 primary 색상 결정.
              </p>
            </div>
            <div className="p-3 border border-border rounded-lg">
              <p className="font-semibold text-foreground mb-1">density</p>
              <p className="text-muted text-xs">
                compact/normal/comfortable. 패딩·폰트 크기를 전역 제어.
              </p>
            </div>
            <div className="p-3 border border-border rounded-lg">
              <p className="font-semibold text-foreground mb-1">radius</p>
              <p className="text-muted text-xs">
                none~full. 모든 컴포넌트의 border-radius 스케일 결정.
              </p>
            </div>
            <div className="p-3 border border-border rounded-lg">
