...
export default function PageLayoutPage() {
  return (
    <ComponentPage
      ...
      props={[
        { name: "maxWidth", type: '"sm"|"md"|"lg"|"xl"|"2xl"|"full"', default: '"xl"', description: "최대 너비" },
          ...
          <div className="border border-border rounded-xl overflow-hidden">
            <Page maxWidth="full" p={5}>
              <Page.Header
                ...
                actions={
                  <button className="px-3 py-1.5 text-xs bg-primary text-white rounded-lg">새로 만들기</button>
                }
              />
              <Page.Body>
