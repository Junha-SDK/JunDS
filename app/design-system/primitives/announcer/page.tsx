  ...
  return (
    <div className="flex flex-col gap-3 max-w-md">
      <div className="flex gap-2">
        <Button size="sm" onClick={() => fire("저장이 완료되었습니다", "polite")}>Polite 알림</Button>
        <Button size="sm" variant="danger" onClick={() => fire("오류가 발생했습니다", "assertive")}>Assertive 알림</Button>
      </div>
...
export default function AnnouncerPage() {
  return (
    <ComponentPage
      ...
      props={[
        { name: "children", type: "ReactNode", description: "Provider 하위 트리. useAnnouncer 훅을 사용하는 컴포넌트를 감쌉니다." },
      ]}
    >
      <Section title="Basic Usage" description="useAnnouncer 훅으로 announce(message, politeness) 함수를 호출해 스크린리더에 메시지를 전달합니다.">
        <Preview>
          <AnnouncerProvider>
            <AnnouncerDemo />
          </AnnouncerProvider>
