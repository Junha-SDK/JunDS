  ...
  return (
    <ComponentPage
      ...
      props={[
        ...
        { name: "active", type: "boolean", default: "true", description: "포커스 트랩 활성화 여부." },
        { name: "autoFocus", type: "boolean", default: "true", description: "마운트 시 첫 번째 포커스 가능한 요소에 자동 포커스." },
        { name: "returnFocus", type: "boolean", default: "true", description: "언마운트 시 이전에 포커스되어 있던 요소로 포커스 복귀." },
      ...
      <Section title="Basic" description="active를 켜면 Tab이 박스 내부에서만 순환합니다.">
        <Preview>
          <div className="flex flex-col gap-3 max-w-md">
            ...
            <FocusGuard active={active} className="p-4 border border-primary/30 rounded-lg bg-primary-light flex flex-col gap-2">
              <Input placeholder="첫 번째 입력" />
              <Input placeholder="두 번째 입력" />
              <Button size="sm" variant="secondary">버튼</Button>
            </FocusGuard>
          </div>
        </Preview>
      </Section>
