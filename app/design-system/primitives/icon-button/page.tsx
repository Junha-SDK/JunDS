...
const CloseIcon = <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M4 4l8 8M12 4l-8 8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/></svg>;
  ...
  return (
    <ComponentPage
      ...
      props={[
        ...
        { name: "variant", type: '"ghost"|"outline"|"filled"', default: '"ghost"', description: "스타일" },
