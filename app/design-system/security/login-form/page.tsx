  ...
  return (
    <ComponentPage
      ...
      props={[
        ...
        { name: "showPasswordStrength", type: "boolean", description: "비밀번호 강도 표시 (회원가입용)" },
        { name: "showConfirmPassword", type: "boolean", description: "비밀번호 확인 필드 (회원가입용)" },
