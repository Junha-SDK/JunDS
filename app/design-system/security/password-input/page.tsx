...
export default function PasswordInputPage() {
  ...
  return (
    <ComponentPage
      ...
      props={[
        { name: "showStrength", type: "boolean", description: "강도 게이지 표시 (취약/보통/양호/강력)" },
        { name: "showRules", type: "boolean", description: "규칙 체크리스트 표시 (8자, 대소문자, 숫자, 특수문자)" },
    ...
    >
      ...
      <Section title="강도만 표시">
        <Preview>
          <div className="max-w-sm">
            <PasswordInput placeholder="비밀번호" showStrength value={pw} onChange={(e) => setPw(e.target.value)} />
          </div>
        </Preview>
      </Section>
