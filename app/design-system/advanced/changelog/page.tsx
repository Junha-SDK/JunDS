    ...
    description: (
      <div className="flex flex-col gap-1.5 mt-1">
        <div className="flex items-center gap-2">
          <Badge variant="primary" size="sm">신규</Badge>
          <span>20개 Primitives, 24개 Composites, 8개 Patterns</span>
        </div>
        <div className="flex items-center gap-2">
          <Badge variant="success" size="sm">기능</Badge>
          <span>테마 선택기 (10 프리셋 + 커스텀), 다크모드</span>
        </div>
        <div className="flex items-center gap-2">
          <Badge variant="info" size="sm">인프라</Badge>
  ...
  },
  {
    ...
    description: (
      <div className="flex flex-col gap-1.5 mt-1">
        ...
        <div className="flex items-center gap-2">
          <Badge variant="primary" size="sm">신규</Badge>
          <span>FormBuilder, InfiniteList, VirtualList, ChartCard, NotificationCenter, SortableList, RichTextEditor</span>
        </div>
        <div className="flex items-center gap-2">
          <Badge variant="success" size="sm">기능</Badge>
        ...
        <div className="flex items-center gap-2">
          <Badge variant="info" size="sm">개선</Badge>
