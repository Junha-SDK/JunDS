...
const initialMessages: Message[] = [
  { id: 1, text: "안녕하세요! JunDS 프로젝트 진행 상황이 어떻게 되나요?", sender: "이서연", side: "left", time: "오후 2:30" },
  { id: 2, text: "네, 현재 컴포넌트 219개 완성했습니다. 테스트도 전부 통과했어요!", sender: "나", side: "right", time: "오후 2:31" },
  { id: 3, text: "와 대단하네요! DataTable은 어떤 기능이 있나요?", sender: "이서연", side: "left", time: "오후 2:32" },
  { id: 4, text: "검색, 필터, 정렬, 가상스크롤, CSV 내보내기, 인라인 편집까지 25개 기능을 지원합니다 🚀", sender: "나", side: "right", time: "오후 2:33" },
  { id: 5, text: "프레임워크 모드도 있다고 들었는데요?", sender: "이서연", side: "left", time: "오후 2:34" },
  { id: 6, text: "네! Box, Flex, Page 같은 코어 컴포넌트로 레이아웃을 토큰 기반으로 제어합니다. 반응형 props도 지원해요.", sender: "나", side: "right", time: "오후 2:35" },
];
