...
const steps: FormWizardStep[] = [
  {
    ...
    content: (
      <div className="text-sm text-muted">이메일과 비밀번호 입력 필드가 들어갈 자리입니다.</div>
    ),
  },
  {
    title: "프로필",
    ...
    content: (
      <div className="text-sm text-muted">닉네임과 자기소개 입력 필드가 들어갈 자리입니다.</div>
    ),
  },
  {
    title: "확인",
...
export default function FormWizardPage() {
  return (
      ...
      props={[
        {
          ...
          type: "FormWizardStep[]",
          description:
            "단계 정의 배열. 각 단계는 title, description, content, validate를 가집니다.",
        },
        {
          name: "onComplete",
          type: "(data: Record<string, unknown>) => void",
          description: "마지막 단계에서 '완료'를 눌렀을 때 호출됩니다.",
        },
    ...
    >
      <Section
        title="Basic"
        description="3단계 위저드. 스테퍼의 완료된 단계를 클릭하면 해당 단계로 돌아갈 수 있습니다."
      >
        <Preview>
