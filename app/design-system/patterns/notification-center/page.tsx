...
const initialNotifications: Notification[] = [
  ...
  },
  {
    id: "2",
    title: "새 댓글",
    message: "김민수님이 PR #42에 댓글을 남겼습니다.",
    time: "15분 전",
    read: false,
    type: "info",
  },
  {
    id: "3",
    title: "디스크 경고",
    message: "서버 디스크 사용량이 85%를 초과했습니다.",
    time: "1시간 전",
    read: false,
    type: "warning",
  },
  {
    id: "4",
    title: "빌드 실패",
    message: "main 브랜치 빌드가 실패했습니다. 로그를 확인하세요.",
    time: "3시간 전",
    read: true,
    type: "error",
  },
      ...
      props={[
        {
          name: "notifications",
          type: "Notification[]",
          description: "알림 배열 (id, title, message, time, read, type)",
        },
