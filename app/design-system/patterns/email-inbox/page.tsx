...
const initial: EmailMessage[] = [
  {
    ...
    folderId: "inbox",
    from: "디자인팀 지우",
    subject: "v3.0 디자인 토큰 검토",
    preview: "변경된 토큰 목록 첨부합니다…",
    receivedAt: Date.now() - 60_000 * 12,
    unread: true,
    attachments: 1,
    labels: ["디자인", "긴급"],
  },
  {
    ...
    folderId: "inbox",
    from: "GitHub",
    subject: "PR #421 리뷰 요청",
    preview: "junha/JunDS 저장소…",
    receivedAt: Date.now() - 60_000 * 60 * 2,
    unread: true,
  },
  {
    id: "m3",
    ...
    from: "결제",
    subject: "구독 갱신 알림",
    preview: "다음 갱신은 5월 30일입니다.",
    receivedAt: Date.now() - 60_000 * 60 * 24 * 2,
  },
];
      ...
      <Section title="Default">
        <Preview>
          <EmailInbox
            ...
            onToggleStar={(id) =>
              setMessages((arr) =>
                arr.map((x) => (x.id === id ? { ...x, starred: !x.starred } : x)),
              )
            }
          />
        </Preview>
