        ...
        <Preview>
          <div className="flex flex-col gap-4">
            ...
            <Callout variant="tip" title="팁">
              <code className="text-xs bg-emerald-100 dark:bg-emerald-900/30 px-1 py-0.5 rounded">
                Cmd + K
              </code>
              를 눌러 빠른 검색을 열 수 있습니다.
            </Callout>
        ...
        <Preview>
          <div className="flex flex-col gap-4">
            <Callout variant="tip" title="클릭하여 펼치기" collapsible>
              이 콜아웃은 접기/펼치기가 가능합니다. 제목을 클릭하면 내용이 토글됩니다. 긴 보충
              설명이나 선택적으로 읽을 수 있는 내용에 적합합니다.
            </Callout>
