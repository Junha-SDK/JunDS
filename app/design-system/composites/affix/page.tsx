...
export default function AffixPage() {
  return (
    <ComponentPage
      ...
      props={[
        { name: "position", type: "{ top?, bottom?, left?, right? }", default: "{ bottom: 20, right: 20 }", description: "고정 위치 (px)" },
        { name: "zIndex", type: "number", default: "40", description: "z-index 값" },
      ]}
    >
      <Section title="Default" description="실제 페이지에서는 viewport 우하단에 떠 있습니다. 아래는 시각적 예시입니다.">
        <Preview>
