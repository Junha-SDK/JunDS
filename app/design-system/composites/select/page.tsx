...
export default function SelectPage() {
  ...
  return (
      ...
      props={[
        {
          ...
          required: true,
          description:
            "드롭다운에 표시할 옵션 목록. 각 옵션은 value, label, icon?, disabled? 속성을 가집니다.",
        },
        {
          name: "value",
          type: "string",
          description: "현재 선택된 값. 제어 컴포넌트로 사용할 때 필요합니다.",
        },
        {
          name: "onChange",
          type: "(value: T) => void",
        ...
        { name: "error", type: "boolean", default: "false", description: "에러 상태 표시 여부" },
        {
          ...
          type: "boolean",
          default: "false",
          description: "드롭다운 내 검색 입력 필드 활성화",
        },
        {
          name: "size",
          type: '"sm" | "md" | "lg"',
          default: '"md"',
          description: "셀렉트 트리거의 크기",
        },
        {
          name: "fullWidth",
          type: "boolean",
    ...
    >
      ...
      <Section
        title="개요"
        description="기본 Select는 클릭 시 드롭다운이 열리며, 옵션 중 하나를 선택할 수 있습니다."
      >
        <Preview>
...
/>`}
          ...
          items={[
            {
              label: "Trigger",
              description:
                "클릭하면 드롭다운을 열고 닫는 버튼 영역입니다. 선택된 값 또는 placeholder를 표시합니다.",
            },
            {
              label: "Dropdown",
              description: "옵션 목록을 감싸는 드롭다운 패널입니다. Trigger 아래에 나타납니다.",
            },
            {
              label: "Option",
              description:
                "개별 선택 가능한 항목입니다. 텍스트, 아이콘을 포함할 수 있으며 disabled 상태를 가질 수 있습니다.",
            },
            {
              label: "Placeholder",
              description: "값이 선택되지 않았을 때 Trigger 내부에 표시되는 안내 텍스트입니다.",
            },
          ]}
        />
      </Section>
      ...
      <Section
        title="검색 가능 Select"
        description="searchable 옵션을 활성화하면 드롭다운 상단에 검색 입력 필드가 나타나 옵션을 필터링할 수 있습니다. 옵션이 많을 때 유용합니다."
      >
        <Preview>
        ...
        <UsageNote type="tip">
          옵션이 7개 이상일 때{" "}
          <code className="text-xs font-mono bg-gray-100 px-1 rounded">searchable</code>을
          활성화하면 사용자 경험이 크게 향상됩니다.
        </UsageNote>
      </Section>
      ...
      <Section
        title="크기 (Sizes)"
        description="sm, md, lg 세 가지 크기를 제공합니다. 주변 UI 요소와 조화를 이루도록 적절한 크기를 선택하세요."
      >
        <VariantGrid cols={3}>
      ...
      <Section
        title="상태 (States)"
        description="Select는 기본, 선택됨, 비활성, 에러 등 다양한 상태를 가질 수 있습니다."
      >
        <VariantGrid cols={2}>
      ...
      <Section
        title="개별 옵션 비활성화"
        description="각 옵션에 disabled 속성을 추가하여 특정 옵션만 선택 불가능하게 만들 수 있습니다."
      >
        <Preview>
          <div className="max-w-xs w-full">
            <Select
        ...
        <Guidelines
          items={[
            ...
            },
            {
              type: "dont",
              description:
                "옵션이 3개 이하라면 Select 대신 Radio 또는 SegmentedControl 사용을 권장합니다.",
            },
            {
              type: "do",
              description:
                "placeholder 텍스트로 어떤 값을 선택해야 하는지 명확하게 안내하세요. (예: '국가를 선택하세요')",
            },
            {
              type: "dont",
              description:
                "옵션 라벨에 지나치게 긴 텍스트를 사용하지 마세요. 트리거 영역을 초과하면 사용성이 떨어집니다.",
            },
            {
              type: "caution",
              description:
                "폼 내에서 필수 선택인 경우 error 상태와 함께 적절한 에러 메시지를 표시하세요.",
            },
            {
              type: "do",
              description:
                "관련된 옵션끼리 논리적 순서로 정렬하세요. 알파벳순, 빈도순 등 사용 맥락에 맞는 정렬 기준을 적용합니다.",
            },
          ]}
        />
      </Section>
