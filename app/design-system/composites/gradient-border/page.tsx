...
export default function GradientBorderPage() {
  return (
    <ComponentPage
      ...
      props={[
        { name: "gradient", type: "string", default: '"from-primary via-accent to-primary"', description: "Tailwind 그라디언트 클래스 시퀀스" },
        { name: "borderWidth", type: "number", default: "2", description: "테두리 두께(px)" },
        { name: "rounded", type: "string", default: '"rounded-xl"', description: "Tailwind 둥근 모서리 클래스" },
        { name: "animated", type: "boolean", default: "false", description: "그라디언트 흐름 애니메이션" },
