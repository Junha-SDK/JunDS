    ...
    <ComponentPage
      ...
      props={[
        { name: "src", type: "string", description: "원본 이미지 URL" },
        {
          ...
          type: "number",
          default: "1",
          description: "결과 영역의 가로/세로 비율",
        },
        {
          name: "onCrop",
          type: "(dataUrl: string) => void",
          description: "자르기 버튼 클릭 시 결과 콜백",
        },
          ...
          <div className="flex flex-wrap gap-6 items-start">
            ...
            <div className="text-sm">
              ...
              {result ? (
                ...
                <div className="w-32 h-32 rounded-lg border border-dashed border-border flex items-center justify-center text-xs text-muted">
                  미리보기
                </div>
              )}
            </div>
