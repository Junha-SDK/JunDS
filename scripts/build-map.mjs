...
const SKIP_DIRS = new Set([".git", ".next", "node_modules", "dist", "coverage", ".turbo"]);
...
lines.push("");
lines.push("_Auto-generated by `npm run map`. Do not edit by hand — your edits will be lost._");
lines.push("");
lines.push("This file is the **single fastest way** for an AI agent to learn the layout of");
lines.push("this repo. Read it once instead of running many `glob`/`grep` calls. After any");
...
await Promise.all([
  ...
  writeFile(cacheFile, JSON.stringify({ signatures: rootSignatures, totalFiles }), "utf8"),
]);
