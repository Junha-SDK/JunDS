...
@layer junds.components {
  ...
  .jd-button:disabled {
    opacity: var(--jd-opacity-40); pointer-events: none; box-shadow: none;
  }
  ...
  jd-button[variant="secondary"] > .jd-button:active {
    background: var(--jd-color-border-light); box-shadow: none; scale: .97;
  }
  ...
  jd-button[variant="danger"] > .jd-button:active {
    scale: .97; box-shadow: inset 0 1px 2px var(--jd-color-shade);
  }
  ...
  jd-button[variant="ghost"] > .jd-button:active {
    background: color-mix(in srgb, var(--jd-color-muted) 16%, transparent); scale: .97;
  }
  ...
  jd-button[variant="outline"] > .jd-button:active {
    background: color-mix(in srgb, var(--jd-color-muted) 12%, transparent); scale: .97;
  }
