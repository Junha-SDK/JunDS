...
export default css`
@layer junds.base {
  jd-brand-switcher:not(:defined) { display: block; }
}
@layer junds.components {
  ...
  jd-brand-switcher[variant="select"] { display: inline-block; }
  ...
  .jd-brand-switcher__text { min-width: 0; }
  .jd-brand-switcher__label { color: var(--jd-color-foreground); }
  ...
  jd-brand-switcher[variant="chips"] .jd-brand-switcher__tagline { display: none; }
