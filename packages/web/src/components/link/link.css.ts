...
@layer junds.components {
  ...
  .jd-link:hover { color: var(--jd-color-primary-ink); text-decoration: underline; }
  ...
  jd-link[variant="subtle"] .jd-link:hover { color: var(--jd-color-primary-ink); }
  jd-link[variant="muted"] .jd-link { color: var(--jd-color-muted); }
  jd-link[variant="muted"] .jd-link:hover { color: var(--jd-color-foreground); }
  jd-link[variant="danger"] .jd-link { color: var(--jd-color-danger-ink); }
