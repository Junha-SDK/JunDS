...
@layer junds.components {
  jd-button-group { display: inline-flex; align-items: center; }

  jd-button-group[full-width] { display: flex; width: 100%; }
  jd-button-group[full-width] > * { flex: 1 1 0; min-width: 0; }
  jd-button-group[full-width] > * > :is(.jd-button, .jd-icon-button) { width: 100%; }

  /* v2 separated: 간격만 두고 모서리는 각자 유지 */
  jd-button-group[separated] { gap: var(--jd-space-1); }
