...
@layer junds.components {
  jd-fzone-card { display: block; }
  jd-fzone-card:not(:defined) { display: block; }
  ...
  .jd-fzone-card__link[hidden] { display: none; }
  .jd-fzone-card__link:hover { box-shadow: var(--jd-shadow-md); }
  .jd-fzone-card__link:focus-visible { outline: none; box-shadow: var(--jd-shadow-focus-ring); }
  ...
  .jd-fzone-card__status {
    ...
    background: color-mix(in srgb, var(--jd-finance-up, var(--jd-color-success)) 80%, var(--jd-color-foreground)); color: #fff;
  }

  .jd-fzone-card__body {
    display: grid; grid-template-columns: 1fr 18px; gap: var(--jd-space-2);
    padding: var(--jd-space-3) var(--jd-space-3) var(--jd-space-2);
  }
  .jd-fzone-card__info { min-width: 0; }

  .jd-fzone-card__row {
    display: flex; align-items: center; justify-content: space-between; gap: var(--jd-space-2);
    margin-block-start: 2px;
  }
  .jd-fzone-card__row:first-child { margin-block-start: 0; }
  .jd-fzone-card__row-label { font-size: 12px; color: var(--jd-color-muted); }
  .jd-fzone-card__meta { font-size: 12px; color: var(--jd-color-muted); font-variant-numeric: tabular-nums; }

  .jd-fzone-card__price {
    font-size: 14px; font-weight: var(--jd-weight-bold); font-variant-numeric: tabular-nums;
  }
  .jd-fzone-card__pct { font-size: 12px; font-weight: var(--jd-weight-bold); font-variant-numeric: tabular-nums; }
  .jd-fzone-card__price[data-dir="up"], .jd-fzone-card__pct[data-dir="up"] {
    color: var(--jd-finance-up, var(--jd-color-success));
  }
  .jd-fzone-card__price[data-dir="down"], .jd-fzone-card__pct[data-dir="down"] {
    color: var(--jd-finance-down, var(--jd-color-danger));
  }

  .jd-fzone-card__levels {
    display: flex; flex-direction: column; gap: 4px; margin-block-start: var(--jd-space-2);
  }
  ...
  .jd-fzone-card__level-label {
    ...
    padding: 1px 4px; border-radius: var(--jd-radius-sm);
  }
  .jd-fzone-card__level[data-muted] .jd-fzone-card__level-label { color: var(--jd-color-muted); }
  ...
  .jd-fzone-card__level[data-muted] .jd-fzone-card__level-value { color: var(--jd-color-muted); }

  .jd-fzone-card__marker { display: block; align-self: start; }
  .jd-fzone-card__marker-guide { stroke: color-mix(in srgb, var(--jd-color-foreground) 15%, transparent); }
  .jd-fzone-card__marker-seg { fill: transparent; }
  .jd-fzone-card__marker-seg[data-on][data-dir="up"] { fill: var(--jd-finance-up, var(--jd-color-success)); }
  .jd-fzone-card__marker-seg[data-on][data-dir="down"] { fill: var(--jd-finance-down, var(--jd-color-danger)); }
}`;
