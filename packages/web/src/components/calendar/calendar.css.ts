...
export default css`
@layer junds.base {
  jd-calendar:not(:defined) { display: none; }
}
@layer junds.components {
  jd-calendar { display: block; font-family: var(--jd-font-sans); }
  ...
  .jd-cal__month-btn[aria-expanded="true"] .jd-cal__caret { transform: rotate(180deg); }
  ...
  .jd-cal__today:focus-visible { outline: none; box-shadow: var(--jd-shadow-focus-ring); }

  .jd-cal__header-right { display: flex; align-items: center; gap: var(--jd-space-1); }
  .jd-cal__view-toggle {
    display: flex;
    align-items: center;
  ...
  .jd-cal__view-tab:focus-visible { outline: none; box-shadow: var(--jd-shadow-focus-ring); }
  ...
  .jd-cal__arrow > svg { width: 0.875rem; height: 0.875rem; }
  .jd-cal__arrow:hover { background: color-mix(in srgb, var(--jd-color-muted) 12%, transparent); }
  .jd-cal__arrow:focus-visible { outline: none; box-shadow: var(--jd-shadow-focus-ring); }
  ...
  .jd-cal__picker[hidden] { display: none; }
  ...
  .jd-cal__picker-arrow { width: 1.75rem; height: 1.75rem; }
  .jd-cal__picker-year {
  ...
  .jd-cal__picker-month:hover { background: color-mix(in srgb, var(--jd-color-muted) 12%, transparent); }
  .jd-cal__picker-month[data-current] {
    background: var(--jd-color-primary);
    color: #fff;
  }
  .jd-cal__picker-month:focus-visible { outline: none; box-shadow: var(--jd-shadow-focus-ring); }
  ...
  .jd-cal__weekdays {
    ...
    border-bottom: var(--jd-border-thin) solid color-mix(in srgb, var(--jd-color-border) 50%, transparent);
  ...
  .jd-cal__cell:hover { box-shadow: var(--jd-shadow-md); background: var(--jd-color-card); }
  .jd-cal__cell[data-empty] {
    cursor: default;
    background: color-mix(in srgb, var(--jd-color-muted) 6%, transparent);
    box-shadow: none;
  }
  .jd-cal__cell[data-in-range] { background: var(--jd-color-primary-light); }
  ...
  .jd-cal__dots { display: flex; align-items: center; gap: var(--jd-space-0-5); flex-wrap: wrap; }
  .jd-cal__dot {
    width: 0.375rem;
    height: 0.375rem;
    border-radius: var(--jd-radius-full);
  ...
  .jd-cal__dots-more { font-size: var(--jd-text-xs); color: var(--jd-color-muted-light); }
}`;
