...
@layer junds.components {
  ...
  jd-stat-card .jd-stat__text { gap: var(--jd-space-2); }
  jd-stat-card .jd-stat__row { gap: var(--jd-space-2); align-items: flex-end; }
  jd-stat-card .jd-stat__label { font-weight: var(--jd-weight-medium); }
  jd-stat-card .jd-stat__value { font-weight: var(--jd-weight-bold); }
  jd-stat-card .jd-stat__main > [slot="icon"] { color: var(--jd-color-muted-light); }
  jd-stat-card .jd-stat__hint { margin-block-start: calc(var(--jd-space-1) * -1); }
  ...
  jd-stat-card[data-trend="up"] { --_jd-stat-trend-bg: var(--jd-color-success-light); }
  jd-stat-card[data-trend="down"] { --_jd-stat-trend-bg: var(--jd-color-danger-light); }
  jd-stat-card[data-trend="flat"] { --_jd-stat-trend-bg: var(--jd-color-border-light); }

  jd-stat-card[clickable] { cursor: pointer; }
