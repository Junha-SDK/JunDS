...
@layer junds.components {
  ...
  jd-image-zoom[data-zoomed] { cursor: grab; touch-action: none; }
  jd-image-zoom:focus-visible { outline: none; box-shadow: var(--jd-shadow-focus-ring); }
  ...
  .jd-image-zoom__controls {
    position: absolute;
    inset-block-end: var(--jd-space-3); inset-inline-end: var(--jd-space-3);
  ...
  .jd-image-zoom__button {
    padding: 0 var(--jd-space-2); border: 0; background: none;
    color: inherit; font: inherit; line-height: 1.5; cursor: pointer;
    border-radius: var(--jd-radius-sm);
  }
  .jd-image-zoom__button:hover:not(:disabled) { opacity: var(--jd-opacity-80); }
  .jd-image-zoom__button:disabled { opacity: var(--jd-opacity-40); cursor: default; }
  .jd-image-zoom__button:focus-visible { outline: none; box-shadow: var(--jd-shadow-focus-ring); }
  ...
  @media (prefers-reduced-motion: reduce) {
    .jd-image-zoom__image { transition: none; }
  }
}`;
