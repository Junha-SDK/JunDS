...
export default css`
@layer junds.base {
  jd-segmented-pill:not(:defined) { display: inline-flex; }
}
@layer junds.components {
  ...
  jd-segmented-pill[full-width] { display: flex; width: 100%; }
  ...
  jd-segmented-pill[full-width] .jd-tabs__tab { flex: 1; }
  ...
  @media (prefers-reduced-motion: reduce) {
    jd-segmented-pill .jd-tabs__tab { transition: none; }
  }
}`;
