...
@layer junds.components {
  ...
  jd-result .jd-empty-state__title {
    font-size: var(--jd-text-xl); margin-block-end: var(--jd-space-2);
  }
  jd-result .jd-empty-state__desc { max-width: 28rem; }
  jd-result > [slot="action"] { margin-block-start: var(--jd-space-6); }
}`;
