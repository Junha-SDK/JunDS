...
@layer junds.components {
  ...
  .jd-alert-dialog__cancel {
    color: var(--jd-color-foreground); background: transparent;
    border: var(--jd-border-thin) solid var(--jd-color-border);
  }
  .jd-alert-dialog__cancel:hover { background: var(--jd-color-card-hover); }
  .jd-alert-dialog__cancel[hidden] { display: none; }
  .jd-alert-dialog__confirm {
    color: #ffffff; background: var(--jd-color-primary); border: 0;
  }
  .jd-alert-dialog__confirm:hover { background: var(--jd-color-primary-hover); }
  jd-alert-dialog[danger] .jd-alert-dialog__confirm { background: var(--jd-color-danger); }
  jd-alert-dialog[danger] .jd-alert-dialog__confirm:hover { background: var(--jd-color-danger-hover); }
  .jd-alert-dialog__cancel:focus-visible,
  .jd-alert-dialog__confirm:focus-visible { outline: none; box-shadow: var(--jd-shadow-focus-ring); }

  @media (prefers-reduced-motion: reduce) {
    .jd-alert-dialog__cancel, .jd-alert-dialog__confirm { transition: none; }
  }
}`;
