...
export default css`
@layer junds.base {
  jd-gradient-border:not(:defined) { display: block; }
}
@layer junds.components {
  ...
  jd-gradient-border[radius="none"] { --jd-gradient-border-radius: var(--jd-radius-none); }
  jd-gradient-border[radius="sm"]   { --jd-gradient-border-radius: var(--jd-radius-sm); }
  jd-gradient-border[radius="md"]   { --jd-gradient-border-radius: var(--jd-radius-md); }
  jd-gradient-border[radius="lg"]   { --jd-gradient-border-radius: var(--jd-radius-lg); }
  jd-gradient-border[radius="2xl"]  { --jd-gradient-border-radius: var(--jd-radius-2xl); }
  jd-gradient-border[radius="full"] { --jd-gradient-border-radius: var(--jd-radius-full); }
  ...
  jd-gradient-border[animated] { background-size: 200% 200%; }
