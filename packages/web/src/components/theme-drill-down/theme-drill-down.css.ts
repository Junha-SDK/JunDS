...
@layer junds.components {
  ...
  jd-theme-drill-down > .jd-modal__panel {
    ...
    color: var(--jd-fin-text); font-variant-numeric: tabular-nums;
    box-shadow: 0 24px 60px rgba(15, 23, 42, 0.28);
  }
  jd-theme-drill-down .jd-modal__panel * { box-sizing: border-box; }
  ...
  .jd-theme-drill-down__pill {
    ...
    padding: var(--jd-space-1) var(--jd-space-3); border-radius: var(--jd-radius-full);
  ...
  .jd-theme-drill-down__title {
    font-size: 13px; font-weight: 800; margin-inline-start: var(--jd-space-1);
  }
  .jd-theme-drill-down__close {
    margin-inline-start: auto; width: 32px; height: 32px; padding: 0;
    display: inline-grid; place-items: center; border: 0;
    border-radius: var(--jd-radius-full);
    background: var(--jd-fin-soft); color: var(--jd-fin-muted); cursor: pointer;
    transition: filter var(--jd-duration-fast) var(--jd-easing-ease-out);
  }
  .jd-theme-drill-down__close:hover { filter: brightness(0.94); }
  .jd-theme-drill-down__close:focus-visible {
    outline: var(--jd-border-medium) solid var(--jd-fin-accent-strong); outline-offset: 1px;
  }

  .jd-theme-drill-down__empty {
    padding: var(--jd-space-6); text-align: center; font-size: 12px; color: var(--jd-fin-muted);
  }

  /* 통계 4칸 */
  .jd-theme-drill-down__stats {
    display: grid; grid-template-columns: repeat(4, 1fr); gap: var(--jd-space-2);
    padding: var(--jd-space-4);
  }
  .jd-theme-drill-down__stat {
    padding: var(--jd-space-2) var(--jd-space-2-5); border-radius: var(--jd-radius-xl);
    background: var(--jd-fin-soft); border: var(--jd-border-thin) solid var(--jd-fin-border);
  }
  .jd-theme-drill-down__stat-label { font-size: 10px; font-weight: 800; color: var(--jd-fin-muted); }
  .jd-theme-drill-down__stat-value {
    margin-top: var(--jd-space-0-5); font-size: 13px; font-weight: 800;
    font-variant-numeric: tabular-nums; color: var(--jd-fin-text);
  }
  .jd-theme-drill-down__stat-value[data-dir="up"] { color: var(--jd-fin-up); }
  .jd-theme-drill-down__stat-value[data-dir="down"] { color: var(--jd-fin-down); }

  /* 섹션 */
  .jd-theme-drill-down__section { padding: 0 var(--jd-space-4) var(--jd-space-4); }
  .jd-theme-drill-down__section-title {
    font-size: 11px; font-weight: 800; letter-spacing: 0.05em;
    margin-block-end: var(--jd-space-2); color: var(--jd-fin-muted);
  }
  ...
  .jd-theme-drill-down__day:nth-child(even) { background: var(--jd-fin-soft); }
  .jd-theme-drill-down__day:last-child { border-block-end: 0; }
  .jd-theme-drill-down__date { font-size: 12px; font-weight: 800; font-variant-numeric: tabular-nums; }
  .jd-theme-drill-down__chips {
    display: flex; flex-wrap: wrap; align-items: center; gap: var(--jd-space-1); min-width: 0;
  }
  .jd-theme-drill-down__chip {
    font-size: 9.5px; font-weight: 800; padding: 1px var(--jd-space-1-5);
    border-radius: var(--jd-radius-full);
  ...
  .jd-theme-drill-down__pct { font-size: 12px; font-weight: 800; font-variant-numeric: tabular-nums; }
  .jd-theme-drill-down__pct[data-dir="up"] { color: var(--jd-fin-up); }
  .jd-theme-drill-down__pct[data-dir="down"] { color: var(--jd-fin-down); }

  /* 왕관 종목 행 */
  .jd-theme-drill-down__leader {
    display: grid; grid-template-columns: auto 1fr auto auto; align-items: center;
    gap: var(--jd-space-2-5); padding: var(--jd-space-2) var(--jd-space-3);
    border-block-end: var(--jd-border-thin) solid var(--jd-fin-border);
  }
  .jd-theme-drill-down__leader:nth-child(even) { background: var(--jd-fin-soft); }
  .jd-theme-drill-down__leader:last-child { border-block-end: 0; }
  .jd-theme-drill-down__crown { color: var(--jd-fin-warning); flex-shrink: 0; }
  .jd-theme-drill-down__leader-name {
    font-size: 12.5px; font-weight: 800;
    overflow: hidden; text-overflow: ellipsis; white-space: nowrap;
  }
  .jd-theme-drill-down__leader-count {
    font-size: 10.5px; font-weight: var(--jd-weight-bold); color: var(--jd-fin-muted);
  ...
  .jd-theme-drill-down__leader-close { font-size: 12px; font-weight: 800; font-variant-numeric: tabular-nums; }
  .jd-theme-drill-down__leader-avg { font-size: 10.5px; font-weight: 800; font-variant-numeric: tabular-nums; }
  .jd-theme-drill-down__leader-avg[data-dir="up"] { color: var(--jd-fin-up); }
  .jd-theme-drill-down__leader-avg[data-dir="down"] { color: var(--jd-fin-down); }

  @media (prefers-reduced-motion: reduce) {
    .jd-theme-drill-down__close { transition: none; }
  }
}`;
