...
@layer junds.components {
  ...
  .jd-image-cropper__handle[data-corner="ne"] {
    ...
    transform: translate(50%, -50%); cursor: nesw-resize;
  }
  ...
  .jd-image-cropper__crop:hover { background: var(--jd-color-primary-hover); }
  .jd-image-cropper__crop:focus-visible { outline: none; box-shadow: var(--jd-shadow-focus-ring); }

  @media (prefers-reduced-motion: reduce) {
    .jd-image-cropper__crop { transition: none; }
  }
}`;
