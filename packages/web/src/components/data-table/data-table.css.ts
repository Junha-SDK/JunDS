...
@layer junds.components {
  ...
  .jd-data-table__toolbar[hidden] { display: none; }
  .jd-data-table__toolbar > [hidden] { display: none; }
  .jd-data-table__toolbar-spacer { flex: 1 1 var(--jd-space-4); }
  ...
  .jd-data-table__search-input::placeholder { color: var(--jd-color-muted-light); }
  ...
  .jd-data-table__search-clear[hidden] { display: none; }
  .jd-data-table__search-clear:hover { color: var(--jd-color-foreground); }
  ...
  jd-data-table[row-clickable] .jd-table__body > .jd-table__row { cursor: pointer; }
  ...
  @media (prefers-reduced-motion: reduce) {
    .jd-data-table__search-input,
    .jd-data-table__density-button,
    .jd-data-table__export-button { transition: none; }
    .jd-data-table__skeleton { animation: none; }
  }
}`;
