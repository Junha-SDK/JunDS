...
@layer junds.components {
  jd-spoiler-block {
    ...
    padding: var(--jd-space-4); overflow: hidden;
  ...
  .jd-spoiler-block__cover[hidden] { display: none; }
  ...
  .jd-spoiler-block__reveal:hover {
    background: var(--jd-color-foreground); box-shadow: var(--jd-shadow-lg);
  }
  ...
  jd-spoiler-block[type="caution"] .jd-spoiler-block__reveal {
    background: var(--jd-color-warning); color: #fff;
  }
  ...
  @media (prefers-reduced-motion: reduce) {
    .jd-spoiler-block__content, .jd-spoiler-block__reveal { transition: none; }
  }
}`;
