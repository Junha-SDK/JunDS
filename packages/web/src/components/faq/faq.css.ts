...
export default css`
@layer junds.base {
  jd-faq:not(:defined) { display: block; }
  jd-faq:not(:defined) > script { display: none; }
}
@layer junds.components {
  ...
  @media (min-width: 640px) {
    jd-faq { padding: var(--jd-space-20) var(--jd-space-6); } /* sm:py-20 sm:px-6 */
  }

  /* ── 헤더 ─────────────────────────────────────────────────── */
  .jd-faq__header { text-align: center; margin-block-end: var(--jd-space-10); } /* mb-10 */
  .jd-faq__header[hidden] { display: none; }
  ...
  .jd-faq__title[hidden] { display: none; }
  @media (min-width: 640px) {
    .jd-faq__title { font-size: var(--jd-text-3xl); }
  }
  ...
  .jd-faq__subtitle[hidden] { display: none; }
  ...
  .jd-faq__controls[hidden] { display: none; }
  @media (min-width: 640px) {
    .jd-faq__controls { flex-direction: row; } /* sm:flex-row */
  }
  ...
  .jd-faq__search[hidden] { display: none; }
  .jd-faq__search::placeholder { color: var(--jd-color-muted); }
  ...
  .jd-faq__filters[hidden] { display: none; }
  ...
  .jd-faq__chip:hover { background: var(--jd-color-card-hover); } /* hover:bg-surface-soft */
  ...
  .jd-faq__item[hidden] { display: none; }
  ...
  .jd-faq__item .jd-faq__question { flex: 1 1 auto; min-width: 0; }
  ...
  .jd-faq__item .jd-faq__chevron > svg { width: 1rem; height: 1rem; }
  .jd-faq__item .jd-faq__trigger[data-state="open"] .jd-faq__chevron { transform: rotate(180deg); }
  ...
  .jd-faq__empty[hidden] { display: none; }

  @media (prefers-reduced-motion: reduce) {
    .jd-faq__chip,
    .jd-faq__item .jd-faq__trigger,
    .jd-faq__item .jd-faq__chevron { transition: none; }
  }
}`;
