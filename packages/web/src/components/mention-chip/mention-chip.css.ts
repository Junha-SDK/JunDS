...
@layer junds.components {
  jd-mention-chip { display: inline; }
  ...
  .jd-mention-chip:hover { text-decoration: underline; }
  .jd-mention-chip:focus-visible {
    outline: var(--jd-border-medium) solid var(--jd-color-primary); outline-offset: 2px;
  }
  .jd-mention-chip__verified { font-size: 11px; }
  .jd-mention-chip__verified[hidden] { display: none; }
}`;
