...
@layer junds.components {
  ...
  .jd-table__caption[hidden] { display: none; }
  ...
  .jd-table__td { color: var(--jd-color-foreground); text-align: start; }

  .jd-table__th[data-align="left"],
  .jd-table__td[data-align="left"] { text-align: left; }
  .jd-table__th[data-align="center"],
  .jd-table__td[data-align="center"] { text-align: center; }
  .jd-table__th[data-align="right"],
  .jd-table__td[data-align="right"] { text-align: right; }

  .jd-table__row {
    border-block-end: var(--jd-border-thin) solid var(--jd-color-border);
    transition: background var(--jd-duration-fast) var(--jd-easing-ease-out);
  }
  .jd-table__body > .jd-table__row:last-child { border-block-end: 0; }
  ...
  jd-table[data-size="sm"] .jd-table__th { padding: var(--jd-space-2) var(--jd-space-3); }
  jd-table[data-size="sm"] .jd-table__td { padding: var(--jd-space-1-5) var(--jd-space-3); }
  jd-table[data-size="md"] .jd-table__th,
  jd-table[data-size="md"] .jd-table__td { padding: var(--jd-space-3) var(--jd-space-4); }
  jd-table[data-size="lg"] .jd-table__th,
  jd-table[data-size="lg"] .jd-table__td { padding: var(--jd-space-4) var(--jd-space-5); }
  ...
  jd-table[row-clickable] .jd-table__body > .jd-table__row { cursor: pointer; }
