...
export default css`
@layer junds.base {
  jd-testimonial-card:not(:defined) { display: block; }
}
@layer junds.components {
  ...
  jd-testimonial-card[variant="card"]:hover { box-shadow: var(--jd-shadow-md); }
  jd-testimonial-card[variant="card"][highlighted] {
    border-color: var(--jd-color-primary);
    box-shadow: var(--jd-shadow-md), 0 0 0 1px color-mix(in srgb, var(--jd-color-primary) 30%, transparent);
  }
  ...
  jd-testimonial-card[variant="minimal"] .jd-testimonial-card__avatar { display: none; }
  ...
  jd-testimonial-card[variant="minimal"] .jd-testimonial-card__role { color: var(--jd-color-muted); }
  ...
  .jd-testimonial-card__star { flex-shrink: 0; }
  ...
  .jd-testimonial-card__avatar[data-image] { background-color: transparent; }
  ...
  @media (prefers-reduced-motion: reduce) {
    jd-testimonial-card[variant="card"] { transition: none; }
  }
}`;
