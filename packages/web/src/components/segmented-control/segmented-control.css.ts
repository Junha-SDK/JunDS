...
@layer junds.components {
  ...
  jd-segmented-control[full-width] { display: flex; width: 100%; }
  jd-segmented-control[disabled] { opacity: var(--jd-opacity-50); }

  .jd-segmented-control__indicator {
    position: absolute;
    top: var(--jd-space-1); bottom: var(--jd-space-1); left: 0;
  ...
  .jd-segmented-control__indicator[hidden] { display: none; }
  ...
  jd-segmented-control[full-width] .jd-segmented-control__seg { flex: 1; }
  ...
  jd-segmented-control[size="lg"] .jd-segmented-control__seg {
    padding: var(--jd-space-2) var(--jd-space-5); font-size: var(--jd-text-lg);
  }

  .jd-segmented-control__seg:hover { color: var(--jd-color-foreground); }
  .jd-segmented-control__seg[data-selected] { color: var(--jd-color-foreground); }
  .jd-segmented-control__seg[data-disabled] {
    opacity: var(--jd-opacity-40); cursor: not-allowed; color: var(--jd-color-muted);
  }
  ...
  .jd-segmented-control__icon { flex-shrink: 0; }
  .jd-segmented-control__icon[hidden] { display: none; }

  @media (prefers-reduced-motion: reduce) {
    .jd-segmented-control__indicator,
    .jd-segmented-control__seg { transition: none; }
  }
}`;
