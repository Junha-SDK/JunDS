...
@layer junds.components {
  jd-skeleton-preset { display: block; } /* CE 기본 display:inline 방지 */
  ...
  jd-skeleton-preset[variant="card"] {
    ...
    padding: var(--jd-space-5); box-sizing: border-box;
    border: var(--jd-border-thin) solid var(--jd-color-border);
    border-radius: var(--jd-radius-xl);
  }
  .jd-skeleton-preset__thumb { height: 10rem; --jd-skeleton-radius: var(--jd-radius-xl); }
  .jd-skeleton-preset__title { height: 1.25rem; width: 75%; }
  .jd-skeleton-preset__subtitle { height: 1rem; width: 50%; }
  .jd-skeleton-preset__actions { display: flex; gap: var(--jd-space-2); }
  .jd-skeleton-preset__chip {
    height: 2rem; width: 5rem; --jd-skeleton-radius: var(--jd-radius-lg);
  }
  ...
  .jd-skeleton-preset__row {
    display: flex; gap: var(--jd-space-4); padding: var(--jd-space-3);
    border-bottom: var(--jd-border-thin) solid var(--jd-color-border);
  }
  .jd-skeleton-preset__head { background: var(--jd-color-border-light); }
  .jd-skeleton-preset__row:last-child { border-bottom: 0; }
  .jd-skeleton-preset__cell { height: 1rem; flex: 1; min-width: 0; }
  ...
  .jd-skeleton-preset__name { height: 1.25rem; width: 8rem; }
  .jd-skeleton-preset__meta { height: 1rem; width: 12rem; }

  /* ── article ────────────────────────────────────────── */
  jd-skeleton-preset[variant="article"] {
    display: flex; flex-direction: column; gap: var(--jd-space-4);
  }
  .jd-skeleton-preset__headline { height: 2rem; width: 75%; }
  .jd-skeleton-preset__byline {
    display: flex; align-items: center; gap: var(--jd-space-3);
  }
  .jd-skeleton-preset__byline .jd-skeleton-preset__avatar { width: 2rem; height: 2rem; }
  .jd-skeleton-preset__by-name { height: 1rem; width: 6rem; }
  .jd-skeleton-preset__by-date { height: 1rem; width: 5rem; }
  .jd-skeleton-preset__hero { height: 12rem; --jd-skeleton-radius: var(--jd-radius-xl); }
  .jd-skeleton-preset__para {
    display: flex; flex-direction: column; gap: var(--jd-space-2);
  }
  .jd-skeleton-preset__p { height: 1rem; width: 100%; }
  .jd-skeleton-preset__p[data-last] { width: 83.333%; } /* v2 w-5/6 */
  ...
  .jd-skeleton-preset__item .jd-skeleton-preset__body { gap: var(--jd-space-1-5); }
  .jd-skeleton-preset__item-title { height: 1rem; width: 66.666%; }
  .jd-skeleton-preset__item-sub { height: 0.75rem; width: 33.333%; }
}`;
