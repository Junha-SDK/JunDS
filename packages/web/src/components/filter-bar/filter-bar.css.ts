...
@layer junds.components {
  ...
  jd-filter-bar > [hidden] { display: none; }
  ...
  .jd-filter-bar__input::placeholder { color: var(--jd-color-muted-light); }
  ...
  .jd-filter-bar__reset:hover { color: var(--jd-color-foreground); background: var(--jd-color-card-hover); }
  ...
  @media (prefers-reduced-motion: reduce) {
    .jd-filter-bar__input,
    .jd-filter-bar__reset { transition: none; }
  }
}`;
