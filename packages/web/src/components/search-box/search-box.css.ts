...
@layer junds.components {
  ...
  jd-search-box:not(:defined) { display: block; }
  ...
  jd-search-box[error] > .jd-combobox__control { border-color: var(--jd-color-danger); }
  ...
  jd-search-box > .jd-combobox__control { border-radius: var(--jd-radius-full); }
  jd-search-box > .jd-combobox__popup {
    border-radius: var(--jd-radius-xl, 16px); overflow: hidden;
    max-height: 60vh;
  }
  jd-search-box .jd-combobox__empty { display: none; } /* v2엔 빈 상태 문구 없음 — 푸터가 대신 */

  /* ⌘K 힌트 — 데스크톱만(v2 hidden md:inline-flex) */
  .jd-search-box__kbd {
    display: none; align-items: center; gap: 4px; flex-shrink: 0;
    padding: 2px 7px; border-radius: 6px;
    background: var(--_soft); border: 1px solid var(--jd-color-border);
    color: var(--_muted);
    font: inherit; font-size: 10px; font-weight: 700; font-variant-numeric: tabular-nums;
  }
  .jd-search-box__kbd > svg { width: 10px; height: 10px; }
  @media (min-width: 768px) { .jd-search-box__kbd { display: inline-flex; } }
  ...
  .jd-search-box__clear {
    ...
    color: var(--_muted); border-radius: var(--jd-radius-full);
  }
  .jd-search-box__clear[hidden] { display: none; }
  .jd-search-box__clear > svg { width: 14px; height: 14px; }
  .jd-search-box__clear:hover { color: var(--jd-color-foreground); }
  .jd-search-box__clear:focus-visible {
    outline: 2px solid var(--jd-color-focus); outline-offset: 1px;
  }
  ...
  .jd-search-box__hit + .jd-search-box__hit { border-top: 1px solid var(--jd-color-border); }
  ...
  .jd-search-box__badge[hidden] { display: none; }
  .jd-search-box__sub {
    font-size: 11px; color: var(--_muted);
    overflow: hidden; text-overflow: ellipsis; white-space: nowrap;
  }
  .jd-search-box__sub[hidden] { display: none; }

  .jd-search-box__aside {
    display: flex; align-items: center; gap: var(--jd-space-2); flex-shrink: 0;
    font-variant-numeric: tabular-nums;
  }
  .jd-search-box__price { font-size: 12.5px; font-weight: 600; }
  .jd-search-box__price[hidden] { display: none; }
  .jd-search-box__change {
    display: inline-flex; align-items: center; gap: 2px;
    font-size: 12px; font-weight: 700; color: var(--_muted);
  }
  .jd-search-box__change[hidden] { display: none; }
  .jd-search-box__change > svg { width: 11px; height: 11px; }
  .jd-search-box__change[data-dir="up"] { color: var(--_up); }
  .jd-search-box__change[data-dir="down"] { color: var(--_down); }
  .jd-search-box__code {
    font-size: 11px; font-weight: 700; color: var(--_muted);
    font-variant-numeric: tabular-nums;
  }
  .jd-search-box__code[hidden] { display: none; }
  ...
  .jd-search-box__footer {
    ...
    border: 0; border-top: 1px solid var(--jd-color-border);
    background: var(--_soft);
    color: var(--jd-fin-accent-strong, var(--jd-color-primary));
    font: inherit; font-size: 12.5px; font-weight: 700; cursor: pointer;
  }
  .jd-search-box__footer[hidden] { display: none; }
  .jd-search-box__footer-chevron { width: 12px; height: 12px; }
  .jd-search-box__footer:hover { filter: brightness(0.97); }
