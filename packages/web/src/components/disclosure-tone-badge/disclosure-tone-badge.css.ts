...
@layer junds.components {
  jd-disclosure-tone-badge {
    ...
    padding: 0 var(--jd-space-2-5); border-radius: var(--jd-radius-lg);
    background: var(--jd-dtb-bg); white-space: nowrap;
    font-family: var(--jd-font-sans); line-height: var(--jd-leading-none);
  }
  jd-disclosure-tone-badge[tone="positive"] { --jd-dtb-fg: color-mix(in srgb, var(--jd-fin-up) 65%, var(--jd-color-foreground)); --jd-dtb-bg: var(--jd-fin-up-soft); }
  jd-disclosure-tone-badge[tone="negative"] { --jd-dtb-fg: color-mix(in srgb, var(--jd-fin-down) 65%, var(--jd-color-foreground)); --jd-dtb-bg: var(--jd-fin-down-soft); }
  jd-disclosure-tone-badge[tone="neutral"]  { --jd-dtb-fg: var(--jd-fin-muted); --jd-dtb-bg: var(--jd-fin-soft); }

  jd-disclosure-tone-badge .jd-disclosure-tone-badge__tone {
    color: var(--jd-dtb-fg); font-size: 11px; font-weight: 800;
    letter-spacing: var(--jd-tracking-wide);
  }
  jd-disclosure-tone-badge .jd-disclosure-tone-badge__cat {
    color: var(--jd-dtb-fg); opacity: .85; font-size: 10.5px; font-weight: 700;
  }
  jd-disclosure-tone-badge .jd-disclosure-tone-badge__conf {
    color: var(--jd-dtb-fg); opacity: .6; font-size: 10px; font-weight: 700;
    font-variant-numeric: tabular-nums;
  }

  /* compact — 톤 라벨만 */
  jd-disclosure-tone-badge[compact] {
    height: 20px; gap: 0; padding: 0 var(--jd-space-1-5);
    border-radius: var(--jd-radius-sm);
  }
  jd-disclosure-tone-badge[compact] .jd-disclosure-tone-badge__tone { font-size: 10.5px; }
  jd-disclosure-tone-badge[compact] .jd-disclosure-tone-badge__cat,
  jd-disclosure-tone-badge[compact] .jd-disclosure-tone-badge__conf { display: none; }
}`;
