...
export default css`
@layer junds.base {
  jd-photo-card:not(:defined) { display: block; }
}
@layer junds.components {
  jd-photo-card { display: block; }
  ...
  .jd-photo-card__badge[hidden] { display: none; }

  .jd-photo-card__caption { padding: var(--jd-space-3); }
  .jd-photo-card__caption[hidden] { display: none; }
  ...
  .jd-photo-card__text[hidden] { display: none; }
  ...
  .jd-photo-card__meta[hidden] { display: none; }
  ...
  .jd-photo-card__stats[hidden] { display: none; }
  ...
  .jd-photo-card__stat[hidden] { display: none; }
  ...
  @media (prefers-reduced-motion: reduce) {
    jd-photo-card[interactive] > .jd-photo-card__figure { transition: none; }
    jd-photo-card[interactive]:hover > .jd-photo-card__figure,
    jd-photo-card[interactive]:focus-within > .jd-photo-card__figure {
      transform: none;
    }
