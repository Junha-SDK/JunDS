        ...
        Canvas { context, size in
            ...
            if showsFill, points.count >= 2 {
                ...
                context.fill(
                    ...
                    with: .linearGradient(
                        Gradient(colors: [
                            color.opacity(spec.fillTopAlpha),
            ...
            if showsBaseline, let y = JdChartGeometry.baselineY(points) {
                ...
                context.stroke(
                    line, with: .color(color.opacity(spec.baselineAlpha)),
                    lineWidth: 1)
            }
