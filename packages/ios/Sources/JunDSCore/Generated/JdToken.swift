...
public enum JdToken {
    public enum Color {
        ...
        public static let statusTodoBg = JdDynamicColor(light: 0xF3F4F6FF, dark: 0xF3F4F6FF)
        public static let statusTodoText = JdDynamicColor(light: 0x6B7280FF, dark: 0x6B7280FF)
        public static let statusProgressBg = JdDynamicColor(light: 0xDBEAFEFF, dark: 0xDBEAFEFF)
        public static let statusProgressText = JdDynamicColor(light: 0x2563EBFF, dark: 0x2563EBFF)
        public static let statusReviewBg = JdDynamicColor(light: 0xFEF3C7FF, dark: 0xFEF3C7FF)
        public static let statusReviewText = JdDynamicColor(light: 0xD97706FF, dark: 0xD97706FF)
        public static let statusDoneBg = JdDynamicColor(light: 0xD1FAE5FF, dark: 0xD1FAE5FF)
        public static let statusDoneText = JdDynamicColor(light: 0x059669FF, dark: 0x059669FF)
        public static let statusHoldBg = JdDynamicColor(light: 0xFEE2E2FF, dark: 0xFEE2E2FF)
        public static let statusHoldText = JdDynamicColor(light: 0xDC2626FF, dark: 0xDC2626FF)
        public static let priorityP0Bg = JdDynamicColor(light: 0xFEF2F2FF, dark: 0xFEF2F2FF)
        public static let priorityP0Text = JdDynamicColor(light: 0xDC2626FF, dark: 0xDC2626FF)
        public static let priorityP0Border = JdDynamicColor(light: 0xFCA5A5FF, dark: 0xFCA5A5FF)
        public static let priorityP1Bg = JdDynamicColor(light: 0xFFF7EDFF, dark: 0xFFF7EDFF)
        public static let priorityP1Text = JdDynamicColor(light: 0xEA580CFF, dark: 0xEA580CFF)
        public static let priorityP1Border = JdDynamicColor(light: 0xFDBA74FF, dark: 0xFDBA74FF)
        public static let priorityP2Bg = JdDynamicColor(light: 0xFEFCE8FF, dark: 0xFEFCE8FF)
        public static let priorityP2Text = JdDynamicColor(light: 0xCA8A04FF, dark: 0xCA8A04FF)
        public static let priorityP2Border = JdDynamicColor(light: 0xFDE047FF, dark: 0xFDE047FF)
        public static let priorityP3Bg = JdDynamicColor(light: 0xEFF6FFFF, dark: 0xEFF6FFFF)
        public static let priorityP3Text = JdDynamicColor(light: 0x2563EBFF, dark: 0x2563EBFF)
        public static let priorityP3Border = JdDynamicColor(light: 0x93C5FDFF, dark: 0x93C5FDFF)
    }
